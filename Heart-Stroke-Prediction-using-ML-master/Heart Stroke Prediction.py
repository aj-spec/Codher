...
def prediction_model():
    ...
    if predictions==0:
        myText.set('*******Heart is healthy********\n********Less chance of Heart Stroke********')
    else:
        myText.set('*******Heart is unhealthy******\n********High chance of Heart Stroke********')
...
win.title("Heart Health Predictor")
...
myText = StringVar();
but = Button(win, text="Predict",width=20,font=("bold",13),bg='grey',fg='black', command=prediction_model)
